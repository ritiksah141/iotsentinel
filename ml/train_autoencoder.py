...
def train_autoencoder():
    ...
    # Save threshold next to model using the model filename stem (e.g. ae_model -> ae_model_threshold.pkl)
    threshold_path = model_path.parent / f"{model_path.stem}_threshold.pkl"
