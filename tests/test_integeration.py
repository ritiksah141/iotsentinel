...
# The `create_test_schema` function is also in `conftest.py`
...
class TestZeekToDatabase:
    ...
    def test_parse_zeek_conn_log_to_database(self, db, temp_zeek_logs):
        ...
        with patch.object(config, 'get') as mock_config:
            ...
            connections = db.get_unprocessed_connections(limit=10)
    ...
    def test_parser_creates_devices_automatically(self, db, temp_zeek_logs):
...
class TestDatabaseToMLPipeline:
    ...
    def test_feature_extraction_from_database(self, db):
        """TC-INT-003: Verify feature extraction from database connections."""
        # Arrange - Insert test connections
        db.add_device('192.168.1.100', device_name='Test Device')
        ...
        # Act
        connections = db.get_unprocessed_connections(limit=20)
...
class TestEndToEndPipeline:
    ...
    def test_full_pipeline_generates_alerts(self, db, temp_zeek_logs):
        ...
        with patch.object(config, 'get') as mock_config:
            ...
            connections = db.get_unprocessed_connections()
            ...
            # Assert
            predictions_count = db.conn.execute(
...
class TestPerformanceIntegration:
    ...
    def test_throughput_1000_connections(self, db):
...
class TestDataConsistency:
    ...
    def test_connection_count_matches_predictions(self, db):
    ...
    def test_alert_device_foreign_key_integrity(self, db):
...
class TestErrorRecovery:
    ...
    def test_parser_continues_after_corrupt_record(self, db, temp_zeek_logs):
    ...
    def test_inference_handles_missing_model_gracefully(self, db):
