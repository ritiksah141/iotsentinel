...
| FR-005  | US-005: 7-Day Baseline Training Period  | 7-Day Baseline Training               | `scripts/baseline_collector.py:25-263`<br>`ml/train_isolation_forest.py:30-145`                      | TC-INT-006, TC-ML-015                         | ✅ Implemented |
